...
*/
/*TO DO LIST
1- بدي اخلي يكون عام لكل المواقع 
2- بدي اخلي يجبلي اسم السيرفر بالاعتماد على اللينك فقط
3- 
*/
...
namespace ef_test4
{
    ...
    {
        public Mecontext() : base(@"Data source=.\TEW_SQLEXPRESS ; Initial Catalog=WEBSCRAPING3 ;Integrated security= true; ")
        {
        }
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 1; i <= 96; i++)
            {
                ...
                foreach (var v_node in v_nodes)
                {
                    ...
                    if (Convert.ToString(v_nodesEpisode) != "") // for how's don't have an episode 
                    {
